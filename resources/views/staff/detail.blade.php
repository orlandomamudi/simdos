            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <div class="float-end">
                                <a href="{{ url('staff/daftar-dosen/' . $detail->id . '/detail/cetak') }}"
                                    class="btn icon icon-left btn-primary btn-sm rounded-pill"><i class="bi bi-printer-fill"></i> cetak</a>
                            </div>
                            <div class="mb-3">
